...
RBFSIZ	EQU	3FH
RECBUF	EQU	8000H
RBFWTP	EQU	RECBUF+RBFSIZ
RBFLMT	EQU	(RECBUF+RBFSIZ)&0FFH
RBFRDP	EQU	RBFWTP+2
RBFCNT	EQU	RBFRDP+2
FLGBST	EQU	RBFCNT+1
TSTACK	EQU	80EDH
...
INTRCV:	PUSH	AF
	PUSH	HL
	IN	A,(PSIOAC)	;CHECK RECEIVE
	BIT	0,A
	JR	Z,INTEXT
	IN	A,(PSIOAD)
	PUSH	AF
	LD	A,(RBFCNT)	;CHECK BUFFER FULL
	CP	RBFSIZ
	JR	NZ,NOTFUL
	POP	AF
	JR	INTEXT
NOTFUL:	LD	HL,(RBFWTP)	;CHECK WRAP
	INC	HL
	LD	A,L
	CP	RBFLMT
	JR	NZ,NWWRAP
...
;	A -> SIO
TXA:	PUSH	AF
TXLOOP:	IN	A,(PSIOAC)	;CHECK STATUS
	BIT	2,A
	JR	Z,TXLOOP
	POP	AF		; TRANSFER
	OUT	(PSIOAD),A
...
;	SIO COMMAND CHAIN
SIOCMD:
	DB	00H,00011000B	;RESET
	DB	04H,01000100B	;SERIAL
	DB	01H,00010000B	;INTERRUPT
	DB	05H,11101010B	;TRANSMIT
	DB	03H,11000001B	;RECEIVE
SIOCML	EQU	$-SIOCMD
;
;	SYSTEM INITIALIZE
SINIT:	LD	SP,TSTACK
...
INITAB: JP	WARMST		; Warm start jump
	...
	JP	RST00		; POINT reflection unused
	JP	RST00		; SET reflection
	JP	RST00			; RESET reflection
