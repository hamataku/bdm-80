...
#define STORAGE_LUN_NBR_USER 1
#define STORAGE_BLK_NBR_USER 192
#define STORAGE_BLK_SIZ_USER 0x200
...
uint8_t buffer[(STORAGE_BLK_NBR_USER - 64) * STORAGE_BLK_SIZ_USER];
__attribute__((section(".ccmram"))) uint8_t buffer2[64 * STORAGE_BLK_SIZ_USER];
