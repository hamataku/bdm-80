...
extern const unsigned char image_blue[]; // BITMAP_BLUE_ID = 0, Size: 48x48 pixels
extern const unsigned char image_blue_icons_settings_32[]; // BITMAP_BLUE_ICONS_SETTINGS_32_ID = 1, Size: 30x30 pixels
extern const unsigned char image_blue_pressed[]; // BITMAP_BLUE_PRESSED_ID = 2, Size: 48x48 pixels
extern const unsigned char image_dark[]; // BITMAP_DARK_ID = 3, Size: 48x48 pixels
extern const unsigned char image_dark_pressed[]; // BITMAP_DARK_PRESSED_ID = 4, Size: 48x48 pixels
extern const unsigned char image_orange[]; // BITMAP_ORANGE_ID = 5, Size: 48x48 pixels
extern const unsigned char image_orange_pressed[]; // BITMAP_ORANGE_PRESSED_ID = 6, Size: 48x48 pixels
extern const unsigned char image_toggle_off[]; // BITMAP_TOGGLE_OFF_ID = 7, Size: 58x32 pixels
extern const unsigned char image_toggle_on[]; // BITMAP_TOGGLE_ON_ID = 8, Size: 58x32 pixels
